This directory contains files related to Appendix B of Learning jQuery, Fourth
...
complete.js
  This file contains the completed contents of B.js, if all code examples
...
listings/
  ...
  chapter, you may copy the contents of the corresponding file into B.js and
